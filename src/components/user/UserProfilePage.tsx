          ...
          <div className="space-y-5 border-t border-white/10 pt-6">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                />
                <button type="button" onClick={() => setShowCurrentPass(!showCurrentPass)} className="absolute right-3 top-1/2 -translate-y-1/2 text-white/50 hover:text-white p-1 transition-colors">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className={`${inputBase} pr-10`}
                />
                <button type="button" onClick={() => setShowNewPass(!showNewPass)} className="absolute right-3 top-1/2 -translate-y-1/2 text-white/50 hover:text-white p-1 transition-colors">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className={`${inputBase} pr-10`}
                />
                <button type="button" onClick={() => setShowConfirmPass(!showConfirmPass)} className="absolute right-3 top-1/2 -translate-y-1/2 text-white/50 hover:text-white p-1 transition-colors">
