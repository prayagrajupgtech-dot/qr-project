        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              />
              <button type="button" onClick={() => setShowCurrentPass(!showCurrentPass)} className={`absolute right-3 top-1/2 -translate-y-1/2 p-1 transition-colors ${theme === "dark" ? "text-white/50 hover:text-white" : "text-gray-400 hover:text-gray-700"}`}>
          ...
          <div>
            ...
            <div className="relative">
              ...
              />
              <button type="button" onClick={() => setShowNewPass(!showNewPass)} className={`absolute right-3 top-1/2 -translate-y-1/2 p-1 transition-colors ${theme === "dark" ? "text-white/50 hover:text-white" : "text-gray-400 hover:text-gray-700"}`}>
          ...
          <div>
            ...
            <div className="relative">
              ...
              />
              <button type="button" onClick={() => setShowConfirmPass(!showConfirmPass)} className={`absolute right-3 top-1/2 -translate-y-1/2 p-1 transition-colors ${theme === "dark" ? "text-white/50 hover:text-white" : "text-gray-400 hover:text-gray-700"}`}>
