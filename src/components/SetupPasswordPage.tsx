          ...
          <form onSubmit={handleSetup} className="space-y-4">
            ...
            <div>
              ...
              <div className="flex items-center bg-white/5 border border-white/10 rounded-xl overflow-hidden focus-within:border-amber-500/60 transition-colors">
                ...
                />
                <button type="button" onClick={() => setShowNewPass(!showNewPass)} className="px-3 py-3 text-white/50 hover:text-white transition-colors flex-shrink-0">
            ...
            <div>
              ...
              <div className="flex items-center bg-white/5 border border-white/10 rounded-xl overflow-hidden focus-within:border-amber-500/60 transition-colors">
                <input
                  ...
                  className="flex-1 bg-transparent px-4 py-3 text-xs font-bold outline-none text-white"
                />
                <button type="button" onClick={() => setShowConfirmPass(!showConfirmPass)} className="px-3 py-3 text-white/50 hover:text-white transition-colors flex-shrink-0">
